...
df_1 = pd.read_csv(r'data/training/df_essays_processed_LIWC Analysis.csv', encoding='utf-8', low_memory = False)
df_2 = pd.read_csv(r'data/training/df_kaggle_cleaned_processed_LIWC Analysis.csv', encoding='utf-8', low_memory = False)
...
pickle.dump(clf_rf_cEXT, open('data/models/clf_rf_cEXT.p', 'wb'))
...
pickle.dump(clf_rf_cAGR, open('data/models/clf_rf_cAGR.p', 'wb'))
...
pickle.dump(clf_rf_cCON, open('data/models/clf_rf_cCON.p', 'wb'))
...
pickle.dump(clf_rf_cOPN, open('data/models/clf_rf_cOPN.p', 'wb'))
